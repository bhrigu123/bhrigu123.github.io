	...
	<div class="">
		...
		<section id="work">
			...
			<div class="work-details">
				...
				<br>
				<hr>
				<p> Worked as a teaching assistant to provide training to students to build a strong foundation in their programming, problem solving and salgorithmic skills.
				</p>
			</div>
		</section>
